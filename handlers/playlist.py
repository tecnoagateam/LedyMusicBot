...
from helpers.queues import QUEUE, get_queue
...
async def playlist(client, m: Message):
   ...
   if chat_id in QUEUE:
      ...
      await m.reply("❌ **İndi Heç birşey yayımlanmır.**")
