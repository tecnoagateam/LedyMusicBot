...
async def update_repo(_, message: Message):
    ...
    msg = await message.reply("🔄 `Yeniləmə başladı...`")
    update_avail = updater()
    if update_avail:
        await msg.edit("✅ Yenilənmə bitdi")
        system("git pull -f && pip3 install -r requirements.txt")
        execle(sys.executable, sys.executable, "main.py", environ)
        return
    await msg.edit("Ledy Music Bot **up-to-date* [main](https://github.com/AzeMusic/LedyMusicBot)", disable_web_page_preview=True)
